...
//            } catch (Exception e) {
//                e.printStackTrace();
//                Log.d("scanQRCodeFromImage", "Failed to process image");
//            }
//        }
//
...
//
//            BarcodeScannerOptions scannerOptions =
//                    new BarcodeScannerOptions.Builder().setBarcodeFormats(Barcode.FORMAT_QR_CODE, Barcode.FORMAT_AZTEC).build();
//
//            BarcodeScanner scanner = BarcodeScanning.getClient(scannerOptions);
